...
public class MenuFrame extends JFrame 
{
   ...
   public MenuFrame()
   {
      ...
      // create Editar... menu item
      JMenuItem editarMenu = new JMenuItem("Editar"); // create file menu
      editarMenu.setMnemonic('E'); // set mnemonic to F

      fileMenu.add(editarMenu);
      editarMenu.addActionListener(
